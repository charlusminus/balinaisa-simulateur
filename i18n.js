...
(function () {
  ...
  var EN = {
    ...
    "JPG, PNG ou WEBP · max 8 Mo · salon, terrasse, jardin, véranda · vue d'ensemble recommandée": "JPG, PNG or WEBP · max 8 MB · living room, terrace, garden, veranda · a wide shot works best",
    ...
    "Télécharger la synthèse technique en PDF": "Download the technical summary as a PDF",
    "Télécharger la note technique complète en PDF": "Download the full technical note as a PDF",
    "Une photo suffit. C'est gratuit, sans création de compte.": "One photo is all it takes. Free, no account needed.",
    "Tester le simulateur": "Try the simulator",
    "au catalogue, réparties en": "in the catalogue, across",
    // --- Traceurs : declaration de Google Tag Manager et Google Analytics (01/09) ---
    "Vos données sont destinées à Balinaisa et à ses prestataires techniques strictement nécessaires au fonctionnement du simulateur : hébergement et automatisation des traitements, génération automatisée du visuel, protection contre les robots, et mesure d'audience. Certains de ces prestataires peuvent être situés hors de l'Union européenne ; dans ce cas, des garanties appropriées encadrent le transfert. Vos données ne sont ni vendues ni cédées à des tiers à des fins commerciales.": "Your data is intended for Balinaisa and for the technical providers strictly necessary to run the simulator: hosting and processing automation, automated image generation, bot protection, and audience measurement. Some of these providers may be located outside the European Union; where that is the case, appropriate safeguards govern the transfer. Your data is neither sold nor passed on to third parties for commercial purposes.",
    "n'utilise aucun traceur publicitaire": "uses no advertising tracker",
    ": pas de pixel de régie, pas de constitution d'audience publicitaire, pas de revente de données. Voici l'inventaire de ce qui est déposé ou lu sur votre appareil. Les quatre premiers éléments relèvent du fonctionnement strictement nécessaire du service, de sa sécurité, ou d'une mesure d'audience exemptée de consentement :": ": no ad-network pixel, no advertising audience building, no resale of data. Here is the full inventory of what is stored on or read from your device. The first four items are strictly necessary to run the service, to its security, or fall under an audience measurement exempt from consent:",
    "Mesure d'audience Google": "Google audience measurement",
    "Nous utilisons": "We use",
    "pour charger nos outils de mesure, et": "to load our measurement tools, and",
    "pour comprendre comment le simulateur est utilisé : pages vues, étapes du parcours effectivement franchies, canal par lequel vous êtes arrivé. L'objectif est d'améliorer l'outil, pas de vous identifier.": "to understand how the simulator is used: pages viewed, which steps are actually completed, and the channel you arrived through. The aim is to improve the tool, not to identify you.",
    "Votre adresse IP est anonymisée": "Your IP address is anonymised",
    ": Google Analytics 4 ne l'enregistre pas et ne la conserve pas. Nous n'activons": ": Google Analytics 4 neither logs nor stores it. We enable",
    "ni les signaux publicitaires Google, ni la personnalisation des annonces, ni le rapprochement de votre visite avec d'autres services Google": "no Google advertising signals, no ad personalisation, and no linking of your visit with other Google services",
    ". Nous ne transmettons à cet outil aucune des informations que vous saisissez dans le formulaire : ni votre nom, ni votre adresse électronique, ni votre téléphone, ni votre photo.": ". We send this tool none of the information you enter in the form: not your name, not your email address, not your phone number, not your photo.",
    "Cette mesure s'appuie sur des cookies déposés par Google, et les données sont traitées par": "This measurement relies on cookies set by Google, and the data is processed by",
    ". Vous pouvez vous y opposer à tout moment en installant le": ". You can opt out at any time by installing the",
    "module de désactivation de Google Analytics": "Google Analytics opt-out add-on",
    ", ou en activant l'option « Ne pas me suivre » de votre navigateur.": ", or by turning on your browser's \"Do Not Track\" setting.",
    ": aucune donnée n'est transmise à un service de polices tiers lors de votre visite.": ": no data is sent to a third-party font service when you visit.",
    "3 pages, 0,8 Mo, visuels inclus": "3 pages, 0.8 MB, images included. French version only for now.",
    "2 pages, l'essentiel du dispositif": "2 pages, the essentials. French version only for now.",
    "6 pages, 1,5 Mo, avec les schémas de la chaîne": "6 pages, 1.5 MB, with the pipeline diagrams. French version only for now.",
    "Balinaisa.ai réinvente l'expérience de l'aménagement": "Balinaisa.ai reinvents the way spaces are imagined",
    "À l'occasion du salon Mode&amp;Objet et de la Paris Design Week, Balinaisa, maison française de mobilier et décoration spécialisée dans le teck d'exception, dévoile Balinaisa.ai, son nouvel outil d'Intelligence Artificielle dédié à l'aménagement et au design d'espaces particuliers ou professionnels : salon, salle à manger, terrasse, jardin, restaurant, hôtel.": "Timed with the Mode&amp;Objet trade fair and Paris Design Week, Balinaisa, a French furniture and decoration house specialising in exceptional teak, is unveiling Balinaisa.ai, its new Artificial Intelligence tool for the design and layout of private and professional spaces: living room, dining room, terrace, garden, restaurant, hotel.",
    "Le principe est simple : photographiez votre espace intérieur ou extérieur. Une minute plus tard, Balinaisa.ai vous renvoie l'image de votre espace réaménagé et le devis des produits qui s'y trouvent, calculé à partir des 97 références réelles du catalogue de la maison, du fauteuil de jardin à la suspension. Gratuit, sans création de compte, sur": "The principle is simple: photograph your space, indoors or out. One minute later, Balinaisa.ai sends back an image of it refurnished, together with a quote for the pieces in it, priced on the 97 real references in the company catalogue, from the garden armchair to the pendant light. Free, no account needed, at",
    "Pour Balinaisa, l'Intelligence Artificielle ne remplace donc pas le travail du designer : elle réduit la distance entre une idée, sa visualisation et son coût.": "For Balinaisa, then, Artificial Intelligence does not replace the designer's work: it shortens the distance between an idea, seeing it, and knowing what it costs.",
    "Révéler tout le potentiel d'un intérieur ou d'un extérieur à partir d'une simple photographie : le pari de Balinaisa.ai, la nouvelle Intelligence Artificielle spécialisée dans l'aménagement et le design.": "Revealing everything an interior or an outdoor space could be, from a single photograph: that is the wager behind Balinaisa.ai, the new Artificial Intelligence devoted to interior design and layout.",
    "La Teste-de-Buch (Bassin d'Arcachon), septembre 2026.": "La Teste-de-Buch, Arcachon Bay, September 2026.",
    ...
    "Derrière Balinaisa.ai, il n'y a pas seulement une technologie. Il y a avant tout un regard. Celui de Dominique Raynal, créateur et expert de mobilier en teck d'exception, dont l'expérience, la connaissance du matériau, le sens des proportions et la manière d'imaginer la relation entre mobilier et architecture constituent l'ADN créatif de la maison Balinaisa. L'Intelligence Artificielle ne remplace pas ce regard : elle le prolonge et permet de rendre une idée immédiatement visible et chiffrée.": "Behind Balinaisa.ai there is not only a technology. There is, above all, an eye. That of Dominique Raynal, a maker and specialist of exceptional teak furniture, whose experience, knowledge of the material, sense of proportion and way of imagining the relationship between furniture and architecture form the creative DNA of the Balinaisa house. Artificial Intelligence does not replace that eye: it extends it, and makes an idea immediately visible and costed.",
    ...
    "Dominique Raynal, président-directeur général de Balinaisa": "Dominique Raynal, chairman and chief executive of Balinaisa",
    "Pour les particuliers comme pour les professionnels": "For private clients and professionals alike",
    "Balinaisa.ai s'adresse naturellement aux particuliers souhaitant repenser leur intérieur ou leurs espaces extérieurs. Mais les usages professionnels sont tout aussi nombreux. Architectes d'intérieur, décorateurs, designers, paysagistes, hôteliers, restaurateurs, professionnels de l'immobilier ou de l'aménagement peuvent utiliser cet outil pour accélérer la projection d'un projet et faciliter les échanges avec leurs clients.": "Balinaisa.ai speaks naturally to private customers wanting to rethink their interior or their outdoor spaces. But the professional uses are just as many. Interior architects, decorators, designers, landscape designers, hoteliers, restaurateurs and property or fit-out professionals can use the tool to speed up the projection of a scheme and make conversations with their own clients easier.",
    "À propos de Balinaisa": "About Balinaisa",
    "Balinaisa est une maison française de mobilier et décoration spécialisée dans une gamme premium en teck. Entre la France et l'Indonésie, elle imagine des collections où design contemporain, matériaux nobles et artisanat traditionnel se rencontrent pour donner naissance à des meubles durables, destinés aux particuliers comme aux plus beaux projets d'hôtellerie, de restauration et d'architecture intérieure.": "Balinaisa is a French furniture and decoration house specialising in a premium teak range. Between France and Indonesia, it designs collections where contemporary design, fine materials and traditional craftsmanship meet to give rise to lasting furniture, for private homes as much as for the finest projects in hospitality, restaurants and interior architecture.",
    ...
    "Dernière mise à jour : septembre 2026": "Last updated: September 2026",
